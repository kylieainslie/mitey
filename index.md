...
|------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| [`si_estim()`](https://kylieainslie.github.io/mitey/reference/si_estim.md)                                       | Estimates the mean and standard deviation of the serial interval distribution             |
| [`plot_si_fit()`](https://kylieainslie.github.io/mitey/reference/plot_si_fit.md)                                 | Plots the fitted serial interval distribution                                             |
| [`wallinga_lipsitch()`](https://kylieainslie.github.io/mitey/reference/wallinga_lipsitch.md)                     | Estimates the time-varying reproduction number using the Wallinga & Lipsitch method       |
| [`generate_synthetic_epidemic()`](https://kylieainslie.github.io/mitey/reference/generate_synthetic_epidemic.md) | Generates a synthetic epidemic curve with specified parameters for testing and simulation |
...
![](reference/figures/README-example_si_plot-1.png)
...
![](reference/figures/README-example_rt_epicurve-1.png)
...
![](reference/figures/README-example_rt_plot-1.png)
...
|------------------------------------------------------------------------------------------------------------------|---------------------------------|-----------------|-----------------------------------------|
| **Serial Interval Estimation**                                                                                   |                                 |                 |                                         |
| [`si_estim()`](https://kylieainslie.github.io/mitey/reference/si_estim.md)                                       | 203 ICC intervals               | **\< 1 second** | EM algorithm on example outbreak data   |
| [`plot_si_fit()`](https://kylieainslie.github.io/mitey/reference/plot_si_fit.md)                                 | Same data + plotting            | **\< 1 second** | Visualization of fitted distribution    |
| **Synthetic Data Generation**                                                                                    |                                 |                 |                                         |
| [`generate_synthetic_epidemic()`](https://kylieainslie.github.io/mitey/reference/generate_synthetic_epidemic.md) | 180 days                        | **\< 1 second** | Creates epidemic curve with known Rt    |
| **Reproduction Number Estimation**                                                                               |                                 |                 |                                         |
| [`wallinga_lipsitch()`](https://kylieainslie.github.io/mitey/reference/wallinga_lipsitch.md) (point estimates)   | 180 days, no bootstrap          | **1-2 seconds** | Fast point estimates only               |
| [`wallinga_lipsitch()`](https://kylieainslie.github.io/mitey/reference/wallinga_lipsitch.md) (with bootstrap)    | 180 days, 100 bootstrap samples | **2-5 minutes** | Including 95% confidence intervals      |
