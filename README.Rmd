...
1. to provide the data and code to reproduce the results in Ainslie, K, Hooiveld, M, and Wallinga, J. 2024. On the epidemiological characteristics of scabies. [pre-print](https://kylieainslie.github.io/mitey/articles/epidemiology_of_scabies.html), and 

2. to provide flexible, documented code for methods not previously available in `R` that can help estimate epidemiological quantities of interest. 
