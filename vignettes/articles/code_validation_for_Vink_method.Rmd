...
```{r print_final_plot, fig.cap="Figure 3. Fitted serial interval curves plotted over symptom onset data for a random sample of the historical data studies from Table 1. Red line is the fitted serial interval curves assuming an underlying Normal distribution.", fig.width=8, fig.height=6}
print(final_plot)
```
