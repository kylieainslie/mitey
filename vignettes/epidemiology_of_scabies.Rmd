...
serial interval distribution with mean 123.24 days and standard deviation
31.55 days, as estimated previously. To obtain confidence intervals on
the daily reproduction number, we used bootstrapping. We
...
```{r forest_plot, echo = FALSE, eval = TRUE, fig.cap="Forest plot of estimated mean serial intervals and pooled mean.", fig.height = 4, fig.width = 4}
