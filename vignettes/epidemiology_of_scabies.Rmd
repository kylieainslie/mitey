...
We used publicly available data on reported symptom onset dates of scabies cases from previously published studies of scabies
...
We obtained weekly reported cases of scabies per 1000 people from 2011 to 2023 in the
Netherlands [@nivel; @deursen2022]. To estimate time-varying reproduction number, we first randomly
...
All analyses were performed in R 4.4.0 [@R-base] using a variety of additional packages not listed previously [@fdrtool; @cowplot; @devtools; @dplyr; @usethis; @ggplot2]. 
...
study <- c("Kaburi et al.", "Ariza et al.", "Akunzirwe et al.", #"Division of Public and Behavioral Health", 
             "Tjon-Kon-Fat et al."#, "Larrosa et al."
           )
# Create a data frame
my_data <- data.frame(
  x = rep(x, 4),
  y = c(y1, y2, y3, y5),
  group = factor(rep(study, each = length(x)),
                 levels = c("Kaburi et al.", "Ariza et al.", "Akunzirwe et al.", #"Division of Public and Behavioral Health", 
                            "Tjon-Kon-Fat et al."#, "Larrosa et al."
                            ))
)
